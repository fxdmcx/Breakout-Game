...
ParticleGenerator::ParticleGenerator(Shader shader, unsigned int texture, int amount)
	: shader(shader), texture(texture), amount(amount)
{
	this->init();
}

void ParticleGenerator::Update(float dt, GameObject &object, int newParticles, glm::vec2 offset)
{
	// Add new particles
	if (!stuck) {
