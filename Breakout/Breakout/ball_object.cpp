...
BallObject::BallObject(glm::vec2 pos, float radius, glm::vec2 velocity, unsigned int ballTexture)
	: GameObject(pos, glm::vec2(radius * 2, radius * 2), ballTexture, glm::vec3(1.0f), velocity),
